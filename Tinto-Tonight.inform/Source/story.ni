...
When play begins:
	...
	say "[line break]";
	say "You have been in Cameroon for six months. Tonight is your first chance to see Obasinjom, [italic type]if[roman type] you can get to Tinto before dark."

Chapter 1 - Setting

Mamfe is a room.
The description of Mamfe is "You are based in Mamfe, the capital of the Manyu division. It feels very crowded for a town of only 40,000 people. You prefer to work in the field, talking to people in the small rural villages, but you come back here to get supplies and to spend time writing. The market is on the [south] edge of town. Your house is on the [north] edge of town."
...
Every turn when the player is in your house:
	If the market has been visited and the village square has not been visited:
		say "I know you are sad. It is frustrating that you could not get to Tinto. You will need to be more bold next time when you are faced with another opportunity like this.";
		end the story.
...
"A typical West African market. [The taxi park] is to the [east]. [Mamfe] town is to the [north].
[if the market has not been visited]
[line break][line break]There are many small vendors, where each one sells one thing, like beans, rice, local vegetables, dried fish, etc. You meet [Mr Agbor], the Rural Councillor, who always asks about your work. You are delighted when he tells you there will be an Obasinjom ceremony at Tinto [italic type]tonight[roman type]. Tonight!?!
...
After exiting when the container exited from is the Kumba road, remove Stefan from play.
...
The description of trousers is "You had these trousers made for you when you first arrived in Mamfe, trying to adapt to local styles."

Yourself is wearing sturdy sandals.
The description of the sandals is "These sandals are so comfortable, even when the road turns muddy after a heavy rain."
...
Stefan is a man in the Kumba road.
